...
public class Reflector {
	...
	public static Object newInstance(Class<?> clz, Class<?>[] sign,
			Object[] args) {
		try {
	...
	public static Method staticMethodOf(Class<?> clz, String mtd,
			Class<?>[] sign) {
		try {
			return clz.getDeclaredMethod(mtd, sign);
		} catch (Exception e) {
	...
	public static Method staticMethodFor(Class<?> clz, String mtd,
			Class<?>[] sign) {
		return staticMethodOf(clz, mtd, sign);
	}

	public static Object call(Object inst, String mtd, Class<?>[] sign,
			Object[] args) {
		try {
	...
	public static void voidCall(Object inst, String mtd, Class<?>[] sign,
			Object[] args) {
		try {
	...
	public static Object callStaticly(Class<?> clz, String mtd,
			Class<?>[] sign, Object[] args) {
		try {
	...
	public static void voidCallStaticly(Class<?> clz, String mtd,
			Class<?>[] sign, Object[] args) {
		try {
